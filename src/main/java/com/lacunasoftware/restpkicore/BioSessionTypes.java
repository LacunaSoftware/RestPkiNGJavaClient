...
/**
 * Gets or Sets BioSessionTypes
 */
public enum BioSessionTypes {
  LIVENESS("Liveness"),
  ENROLLMENT("Enrollment"),
  AUTHENTICATION("Authentication"),
  IDENTIFICATIONDOCUMENTCAPTURE("IdentificationDocumentCapture"),
  IDENTIFICATIONDOCUMENTFACEMATCHING("IdentificationDocumentFaceMatching"),
  VIDEOIDENTIFICATION("VideoIdentification");

  private String value;

  BioSessionTypes(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static BioSessionTypes fromValue(String input) {
    for (BioSessionTypes b : BioSessionTypes.values()) {
