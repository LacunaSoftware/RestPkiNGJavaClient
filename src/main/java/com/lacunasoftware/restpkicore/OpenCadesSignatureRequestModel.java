...
import com.lacunasoftware.restpkicore.AuditPackageOptions;
...
public class OpenCadesSignatureRequestModel {
  ...
  public OpenCadesSignatureRequestModel extractEncapsulatedContent(Boolean extractEncapsulatedContent) {
    this.extractEncapsulatedContent = extractEncapsulatedContent;
    return this;
  }

   /**
   * Get extractEncapsulatedContent
   * @return extractEncapsulatedContent
  **/
  @Schema(description = "")
  public Boolean isExtractEncapsulatedContent() {
    return extractEncapsulatedContent;
  }
  ...
  public OpenCadesSignatureRequestModel file(FileModel file) {
    this.file = file;
    return this;
  }
  ...
  **/
  ...
  public OpenCadesSignatureRequestModel validate(Boolean validate) {
  ...
  **/
  ...
  public OpenCadesSignatureRequestModel auditPackage(AuditPackageOptions auditPackage) {
  ...
  **/
  ...
  public OpenCadesSignatureRequestModel defaultSignaturePolicyId(UUID defaultSignaturePolicyId) {
  ...
  **/
  @Schema(description = "Default signature policy to be used to validate signature. This value is used to validate signatures without an  explicit validation policy attribute and also signatures with an explicit validation policy attribute that is not  among the policies specified in AcceptableExplicitPolicies. In order to accept only a certain list of explicit  policies, this value should be omitted.")
  ...
  public OpenCadesSignatureRequestModel acceptableExplicitPolicies(List<UUID> acceptableExplicitPolicies) {
    this.acceptableExplicitPolicies = acceptableExplicitPolicies;
    return this;
  }

  public OpenCadesSignatureRequestModel addAcceptableExplicitPoliciesItem(UUID acceptableExplicitPoliciesItem) {
    if (this.acceptableExplicitPolicies == null) {
      this.acceptableExplicitPolicies = new ArrayList<>();
    }
    this.acceptableExplicitPolicies.add(acceptableExplicitPoliciesItem);
    return this;
  }
  ...
  **/
  @Schema(description = "List of explicit policies that should be accepted when validating signatures with a explicit validation policy attribute.  If a signature being validated has an explicit validation policy attribute which is not among the values passed, then the  policy specified in DefaultSignaturePolicyId is used. In order to accept only the given list of explicit policies, omit  the value DefaultSignaturePolicyId.")
  ...
  public OpenCadesSignatureRequestModel securityContextId(UUID securityContextId) {
  ...
  **/
  ...
  public OpenCadesSignatureRequestModel ignoreRevocationStatusUnknown(Boolean ignoreRevocationStatusUnknown) {
  ...
  **/
  ...
  public OpenCadesSignatureRequestModel trustUncertifiedSigningTime(Boolean trustUncertifiedSigningTime) {
  ...
  **/
  ...
  public OpenCadesSignatureRequestModel dataHashes(List<DigestAlgorithmAndValueModel> dataHashes) {
    this.dataHashes = dataHashes;
    return this;
  }

  public OpenCadesSignatureRequestModel addDataHashesItem(DigestAlgorithmAndValueModel dataHashesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    OpenCadesSignatureRequestModel openCadesSignatureRequestModel = (OpenCadesSignatureRequestModel) o;
    return Objects.equals(this.extractEncapsulatedContent, openCadesSignatureRequestModel.extractEncapsulatedContent) &&
        Objects.equals(this.file, openCadesSignatureRequestModel.file) &&
        Objects.equals(this.validate, openCadesSignatureRequestModel.validate) &&
        Objects.equals(this.auditPackage, openCadesSignatureRequestModel.auditPackage) &&
        Objects.equals(this.defaultSignaturePolicyId, openCadesSignatureRequestModel.defaultSignaturePolicyId) &&
        Objects.equals(this.acceptableExplicitPolicies, openCadesSignatureRequestModel.acceptableExplicitPolicies) &&
        Objects.equals(this.securityContextId, openCadesSignatureRequestModel.securityContextId) &&
        Objects.equals(this.ignoreRevocationStatusUnknown, openCadesSignatureRequestModel.ignoreRevocationStatusUnknown) &&
        Objects.equals(this.trustUncertifiedSigningTime, openCadesSignatureRequestModel.trustUncertifiedSigningTime) &&
        Objects.equals(this.dataHashes, openCadesSignatureRequestModel.dataHashes);
  }

  @Override
  public int hashCode() {
    return Objects.hash(extractEncapsulatedContent, file, validate, auditPackage, defaultSignaturePolicyId, acceptableExplicitPolicies, securityContextId, ignoreRevocationStatusUnknown, trustUncertifiedSigningTime, dataHashes);
  }
  ...
  public String toString() {
    ...
    sb.append("    extractEncapsulatedContent: ").append(toIndentedString(extractEncapsulatedContent)).append("\n");
