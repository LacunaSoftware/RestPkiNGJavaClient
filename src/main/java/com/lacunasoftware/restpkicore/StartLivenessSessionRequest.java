...
import com.lacunasoftware.restpkicore.FaceLivenessProviders;
import io.swagger.v3.oas.annotations.media.Schema;
/**
 * StartLivenessSessionRequest
 */
...
public class StartLivenessSessionRequest {
  ...
  @JsonProperty("faceLivenessProvider")
  private FaceLivenessProviders faceLivenessProvider = null;
  ...
  public StartLivenessSessionRequest subjectIdentifier(String subjectIdentifier) {
  ...
  **/
  ...
  public StartLivenessSessionRequest captureIdentificationDocument(Boolean captureIdentificationDocument) {
  ...
  **/
  ...
  public StartLivenessSessionRequest faceCaptureProvider(FaceCaptureProviders faceCaptureProvider) {
  ...
  **/
  ...
  public StartLivenessSessionRequest faceLivenessProvider(FaceLivenessProviders faceLivenessProvider) {
    this.faceLivenessProvider = faceLivenessProvider;
    return this;
  }

   /**
   * Get faceLivenessProvider
   * @return faceLivenessProvider
  **/
  @Schema(description = "")
  public FaceLivenessProviders getFaceLivenessProvider() {
    return faceLivenessProvider;
  }

  public void setFaceLivenessProvider(FaceLivenessProviders faceLivenessProvider) {
    this.faceLivenessProvider = faceLivenessProvider;
  }

  public StartLivenessSessionRequest trustedOrigin(String trustedOrigin) {
  ...
  **/
  ...
  public StartLivenessSessionRequest returnUrl(String returnUrl) {
  ...
  **/
  ...
  public StartLivenessSessionRequest platformPreference(BioSessionPlatformPreferences platformPreference) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StartLivenessSessionRequest startLivenessSessionRequest = (StartLivenessSessionRequest) o;
    return Objects.equals(this.subjectIdentifier, startLivenessSessionRequest.subjectIdentifier) &&
        Objects.equals(this.captureIdentificationDocument, startLivenessSessionRequest.captureIdentificationDocument) &&
        Objects.equals(this.faceCaptureProvider, startLivenessSessionRequest.faceCaptureProvider) &&
        Objects.equals(this.faceLivenessProvider, startLivenessSessionRequest.faceLivenessProvider) &&
        Objects.equals(this.trustedOrigin, startLivenessSessionRequest.trustedOrigin) &&
        Objects.equals(this.returnUrl, startLivenessSessionRequest.returnUrl) &&
        Objects.equals(this.platformPreference, startLivenessSessionRequest.platformPreference);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subjectIdentifier, captureIdentificationDocument, faceCaptureProvider, faceLivenessProvider, trustedOrigin, returnUrl, platformPreference);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartLivenessSessionRequest {\n");
    ...
    sb.append("    faceLivenessProvider: ").append(toIndentedString(faceLivenessProvider)).append("\n");
