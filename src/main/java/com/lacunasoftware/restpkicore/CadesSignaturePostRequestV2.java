...
public class CadesSignaturePostRequestV2 {
  ...
  public CadesSignaturePostRequestV2 dataHashes(List<DigestAlgorithmAndValueModel> dataHashes) {
    this.dataHashes = dataHashes;
    return this;
  }

  public CadesSignaturePostRequestV2 addDataHashesItem(DigestAlgorithmAndValueModel dataHashesItem) {
  ...
  **/
  ...
  public CadesSignaturePostRequestV2 contentToSign(byte[] contentToSign) {
  ...
  **/
  ...
  public void setContentToSign(byte[] contentToSign) {
    this.contentToSign = contentToSign;
  }

  public CadesSignaturePostRequestV2 cmsToCoSign(byte[] cmsToCoSign) {
  ...
  **/
  ...
  public CadesSignaturePostRequestV2 encapsulateContent(Boolean encapsulateContent) {
  ...
  **/
  ...
  public CadesSignaturePostRequestV2 certificate(byte[] certificate) {
  ...
  **/
  ...
  public CadesSignaturePostRequestV2 signaturePolicyId(UUID signaturePolicyId) {
  ...
  **/
  ...
  public CadesSignaturePostRequestV2 securityContextId(UUID securityContextId) {
  ...
  **/
  ...
  public CadesSignaturePostRequestV2 callbackArgument(String callbackArgument) {
  ...
  **/
  ...
  public CadesSignaturePostRequestV2 ignoreRevocationStatusUnknown(Boolean ignoreRevocationStatusUnknown) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CadesSignaturePostRequestV2 cadesSignaturePostRequestV2 = (CadesSignaturePostRequestV2) o;
    return Objects.equals(this.dataHashes, cadesSignaturePostRequestV2.dataHashes) &&
        Arrays.equals(this.contentToSign, cadesSignaturePostRequestV2.contentToSign) &&
        Arrays.equals(this.cmsToCoSign, cadesSignaturePostRequestV2.cmsToCoSign) &&
        Objects.equals(this.encapsulateContent, cadesSignaturePostRequestV2.encapsulateContent) &&
        Arrays.equals(this.certificate, cadesSignaturePostRequestV2.certificate) &&
        Objects.equals(this.signaturePolicyId, cadesSignaturePostRequestV2.signaturePolicyId) &&
        Objects.equals(this.securityContextId, cadesSignaturePostRequestV2.securityContextId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(dataHashes, Arrays.hashCode(contentToSign), Arrays.hashCode(cmsToCoSign), encapsulateContent, Arrays.hashCode(certificate), signaturePolicyId, securityContextId, callbackArgument, ignoreRevocationStatusUnknown);
  }
  ...
  public String toString() {
    ...
    sb.append("    contentToSign: ").append(toIndentedString(contentToSign)).append("\n");
