...
public class DocumentModel {
  ...
  @JsonProperty("signatureSessionIds")
  private List<UUID> signatureSessionIds = null;
  ...
  **/
  ...
  public DocumentModel signatureSessionIds(List<UUID> signatureSessionIds) {
    this.signatureSessionIds = signatureSessionIds;
    return this;
  }

  public DocumentModel addSignatureSessionIdsItem(UUID signatureSessionIdsItem) {
    if (this.signatureSessionIds == null) {
      this.signatureSessionIds = new ArrayList<>();
    }
    this.signatureSessionIds.add(signatureSessionIdsItem);
    return this;
  }

   /**
   * Get signatureSessionIds
   * @return signatureSessionIds
  **/
  @Schema(description = "")
  public List<UUID> getSignatureSessionIds() {
    return signatureSessionIds;
  }

  public void setSignatureSessionIds(List<UUID> signatureSessionIds) {
    this.signatureSessionIds = signatureSessionIds;
  }
  ...
  **/
  ...
  public DocumentModel key(String key) {
   ...
   /**
   * The key used to lookup this document on the validation page, unformatted (digits and letters only)
   * @return key
  **/
  @Schema(description = "The key used to lookup this document on the validation page, unformatted (digits and letters only)")
  ...
  public DocumentModel dateCreated(Date dateCreated) {
   ...
   * @return dateCreated
  **/
  @Schema(description = "Date and time the document was created")
  ...
  public DocumentModel subscriptionId(UUID subscriptionId) {
    this.subscriptionId = subscriptionId;
    return this;
  }

   /**
   * Subscription of the document
   * @return subscriptionId
  **/
  @Schema(description = "Subscription of the document")
  ...
  public DocumentModel formattedKey(String formattedKey) {
   ...
   /**
   * The key used to lookup this document on the validation page, in formatted form
   * @return formattedKey
  **/
  @Schema(description = "The key used to lookup this document on the validation page, in formatted form")
  ...
  **/
  ...
  public DocumentModel availableUntil(Date availableUntil) {
   ...
   /**
   * Date and time until which the document will be available for download
   * @return availableUntil
  **/
  @Schema(description = "Date and time until which the document will be available for download")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.signers, documentModel.signers) &&
        ...
        Objects.equals(this.signatureSessionIds, documentModel.signatureSessionIds) &&
        Objects.equals(this.id, documentModel.id) &&
        Objects.equals(this.key, documentModel.key) &&
        Objects.equals(this.dateCreated, documentModel.dateCreated) &&
        Objects.equals(this.subscriptionId, documentModel.subscriptionId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(signers, metadata, signatureSessionIds, id, key, dateCreated, subscriptionId, formattedKey, originalFile, markedFile, signedFile, signatureType, availableUntil);
  }
  ...
  public String toString() {
    ...
    sb.append("    signatureSessionIds: ").append(toIndentedString(signatureSessionIds)).append("\n");
