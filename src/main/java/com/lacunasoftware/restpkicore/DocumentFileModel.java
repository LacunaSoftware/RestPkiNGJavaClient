...
/**
 * Represents a document&#x27;s file, either its original file or the signed file
 */
@Schema(description = "Represents a document's file, either its original file or the signed file")
...
public class DocumentFileModel {
  ...
  **/
  ...
  public DocumentFileModel content(byte[] content) {
   ...
   /**
   * File&#x27;s content (encoded as Base64 if using the REST API directly)
   * @return content
  **/
  @Schema(description = "File's content (encoded as Base64 if using the REST API directly)")
  ...
  public DocumentFileModel blobToken(String blobToken) {
   ...
   /**
   * Token granting access to reference a file stored on the server side
   * @return blobToken
  **/
  @Schema(description = "Token granting access to reference a file stored on the server side")
  ...
  public DocumentFileModel url(String url) {
   ...
   /**
   * When submitting a file to the API, this can be used as a way to reference the file. The URL must support the GET method and it should have  all the necessary parameters to grant access without any additional headers. When the API is returning a file, this field holds a temporary  absolute URL for downloading the file, expiring after a short period of time (normally 1 hour), so DO NOT STORE IT.
   * @return url
  **/
  @Schema(description = "When submitting a file to the API, this can be used as a way to reference the file. The URL must support the GET method and it should have  all the necessary parameters to grant access without any additional headers. When the API is returning a file, this field holds a temporary  absolute URL for downloading the file, expiring after a short period of time (normally 1 hour), so DO NOT STORE IT.")
  ...
  public DocumentFileModel name(String name) {
   ...
   /**
   * Original file name or suggested file name for the signed file (depending on the case)
   * @return name
  **/
  @Schema(description = "Original file name or suggested file name for the signed file (depending on the case)")
   ...
   * @return length
  **/
  @Schema(description = "Length in bytes of the file")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.mimeType, documentFileModel.mimeType) &&
        ...
        Objects.equals(this.length, documentFileModel.length) &&
        Objects.equals(this.contentType, documentFileModel.contentType) &&
        Objects.equals(this.location, documentFileModel.location);
  }
