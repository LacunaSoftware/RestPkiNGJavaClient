...
public class InspectSignatureResponse {
  ...
  @JsonProperty("missingDataHash")
  private DigestAlgorithms missingDataHash = null;
  ...
  private FileReferenceModel encapsulatedContent = null;
  ...
  public InspectSignatureResponse success(Boolean success) {
   ...
   /**
   * Wether the signature inspection operation was successful. If not, check &#x60;failure&#x60; for the reason.
   * @return success
  **/
  @Schema(description = "Wether the signature inspection operation was successful. If not, check `failure` for the reason.")
  ...
  **/
  ...
  public InspectSignatureResponse addSignersItem(SignerModel signersItem) {
   ...
   /**
   * Information about each signer found on the signed file. If the file is not signed, this will be empty.
   * @return signers
  **/
  @Schema(description = "Information about each signer found on the signed file. If the file is not signed, this will be empty.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.success, inspectSignatureResponse.success) &&
        ...
        Objects.equals(this.hasEncapsulatedContent, inspectSignatureResponse.hasEncapsulatedContent) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(success, failure, missingDataHash, signers, document, hasEncapsulatedContent, encapsulatedContentType, encapsulatedContent);
  }
