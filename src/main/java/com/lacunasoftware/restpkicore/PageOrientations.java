...
public enum PageOrientations {
  ...
  @JsonCreator
  public static PageOrientations fromValue(String input) {
    for (PageOrientations b : PageOrientations.values()) {
