...
/**
 * Gets or Sets PdfMarkElementType
 */
public enum PdfMarkElementType {
  ...
  PdfMarkElementType(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PdfMarkElementType fromValue(String input) {
    for (PdfMarkElementType b : PdfMarkElementType.values()) {
