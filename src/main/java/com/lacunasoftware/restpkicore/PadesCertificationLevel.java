...
/**
 * Gets or Sets PadesCertificationLevel
 */
public enum PadesCertificationLevel {
  ...
  @JsonCreator
  public static PadesCertificationLevel fromValue(String input) {
    for (PadesCertificationLevel b : PadesCertificationLevel.values()) {
