...
public class CreateSignatureSessionRequest {
  ...
  public CreateSignatureSessionRequest returnUrl(String returnUrl) {
   ...
   /**
   * The absolute URL to which the user will be redirected upon completion of the process. Omit if the signature page will be openened on a new tab.
   * @return returnUrl
  **/
  @Schema(description = "The absolute URL to which the user will be redirected upon completion of the process. Omit if the signature page will be openened on a new tab.")
  ...
  **/
  ...
  public CreateSignatureSessionRequest callbackArgument(String callbackArgument) {
   ...
   /**
   * A callback argument that can be used to store any app-specific state. This parameter can be retrieved later when fetching the session&#x27;s results, and is stored in encrypted form at all times.
   * @return callbackArgument
  **/
  @Schema(description = "A callback argument that can be used to store any app-specific state. This parameter can be retrieved later when fetching the session's results, and is stored in encrypted form at all times.")
  ...
  public CreateSignatureSessionRequest enableBackgroundProcessing(Boolean enableBackgroundProcessing) {
   ...
   /**
   * By default, users are kept waiting while documents are processed before being redirected back to your application. Specify &#x60;true&#x60; to redirect users without waiting  (your application must then be ready to handle the case of a signature session whose documents are not readily available for download!).
   * @return enableBackgroundProcessing
  **/
  @Schema(description = "By default, users are kept waiting while documents are processed before being redirected back to your application. Specify `true` to redirect users without waiting  (your application must then be ready to handle the case of a signature session whose documents are not readily available for download!).")
  ...
  public CreateSignatureSessionRequest disableDownloads(Boolean disableDownloads) {
   ...
   /**
   * By default, users can download the files after signing, before returning to your app. If you feel like this feature is hindering the process in any way, pass &#x60;true&#x60;  to disable downloading of signed files. Users will only be able to download signed files back on your app.
   * @return disableDownloads
  **/
  @Schema(description = "By default, users can download the files after signing, before returning to your app. If you feel like this feature is hindering the process in any way, pass `true`  to disable downloading of signed files. Users will only be able to download signed files back on your app.")
  ...
  public CreateSignatureSessionRequest putDocumentMetadataItem(String key, List<String> documentMetadataItem) {
   ...
   /**
   * Metadata to be added to each document that the user uploads on the session (if uploading is allowed on the session)
   * @return documentMetadata
  **/
  @Schema(description = "Metadata to be added to each document that the user uploads on the session (if uploading is allowed on the session)")
  ...
  public CreateSignatureSessionRequest addDocumentsItem(SignatureSessionDocumentData documentsItem) {
   ...
   /**
   * Documents to be signed during the session. If omitted, the user will be able to upload his own documents to the session.
   * @return documents
  **/
  @Schema(description = "Documents to be signed during the session. If omitted, the user will be able to upload his own documents to the session.")
  ...
  public CreateSignatureSessionRequest addCertificateRequirementsItem(CertificateRequirement certificateRequirementsItem) {
   ...
   /**
   * A list of requirements that the certificate must meet in order to be used for signature of the documents on this session
   * @return certificateRequirements
  **/
  @Schema(description = "A list of requirements that the certificate must meet in order to be used for signature of the documents on this session")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(returnUrl, securityContextId, callbackArgument, enableBackgroundProcessing, disableDownloads, documentMetadata, documents, certificateRequirements, pdfSignatureOptions, cmsSignatureOptions);
  }
