...
public class InspectSignatureRequest {
  ...
  **/
  ...
  public InspectSignatureRequest validate(Boolean validate) {
   ...
   /**
   * Whether the signatures should be validated.
   * @return validate
  **/
  @Schema(description = "Whether the signatures should be validated.")
  ...
  public InspectSignatureRequest securityContextId(UUID securityContextId) {
   ...
   /**
   * If validating signatures, optionally specify the ID of the security context to be used to validate signer certificates. If omitted, the  caller&#x27;s default security is used.
   * @return securityContextId
  **/
  @Schema(description = "If validating signatures, optionally specify the ID of the security context to be used to validate signer certificates. If omitted, the  caller's default security is used.")
  ...
  public InspectSignatureRequest ignoreRevocationStatusUnknown(Boolean ignoreRevocationStatusUnknown) {
  ...
  **/
  ...
  public InspectSignatureRequest trustUncertifiedSigningTime(Boolean trustUncertifiedSigningTime) {
  ...
  **/
  ...
  public InspectSignatureRequest addDataHashesItem(DigestAlgorithmAndValueModel dataHashesItem) {
   ...
   /**
   * If validating detached CMS/CAdES signatures, the detached data file must either be passed on &#x60;dataFile&#x60; or its digest(s) must be passed here. Pass  at least the SHA-256 digest of the file (other digests may be necessary depending on the signature algorithm used by the signers).
   * @return dataHashes
  **/
  @Schema(description = "If validating detached CMS/CAdES signatures, the detached data file must either be passed on `dataFile` or its digest(s) must be passed here. Pass  at least the SHA-256 digest of the file (other digests may be necessary depending on the signature algorithm used by the signers).")
  ...
  public InspectSignatureRequest extractEncapsulatedContent(Boolean extractEncapsulatedContent) {
    this.extractEncapsulatedContent = extractEncapsulatedContent;
    return this;
  }

   /**
   * When &#x60;True&#x60;, if applicable, that is, if the signature file being opened is a CMS signature, the encapsulated content is returned  on the response. If not applicable, that is, if the signature file is not a CMS signature, this property is ignored.
   * @return extractEncapsulatedContent
  **/
  @Schema(description = "When `True`, if applicable, that is, if the signature file being opened is a CMS signature, the encapsulated content is returned  on the response. If not applicable, that is, if the signature file is not a CMS signature, this property is ignored.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.file, inspectSignatureRequest.file) &&
        ...
        Objects.equals(this.ignoreRevocationStatusUnknown, inspectSignatureRequest.ignoreRevocationStatusUnknown) &&
        Objects.equals(this.trustUncertifiedSigningTime, inspectSignatureRequest.trustUncertifiedSigningTime) &&
        ...
        Objects.equals(this.extractEncapsulatedContent, inspectSignatureRequest.extractEncapsulatedContent);
  }

  @Override
  public int hashCode() {
    return Objects.hash(file, validate, securityContextId, ignoreRevocationStatusUnknown, trustUncertifiedSigningTime, dataFile, dataHashes, extractEncapsulatedContent);
  }
