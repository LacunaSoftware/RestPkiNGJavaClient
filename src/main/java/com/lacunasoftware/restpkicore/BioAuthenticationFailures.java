...
/**
 * Gets or Sets BioAuthenticationFailures
 */
public enum BioAuthenticationFailures {
  ...
  BioAuthenticationFailures(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static BioAuthenticationFailures fromValue(String input) {
    for (BioAuthenticationFailures b : BioAuthenticationFailures.values()) {
