...
/**
 * StartBioEnrollmentSessionRequest
 */
...
public class StartBioEnrollmentSessionRequest {
  @JsonProperty("subjectIdentifier")
  private String subjectIdentifier = null;

  @JsonProperty("captureIdentificationDocument")
  private Boolean captureIdentificationDocument = null;

  @JsonProperty("dangerousOverrideIfAlreadyEnrolled")
  private Boolean dangerousOverrideIfAlreadyEnrolled = null;

  @JsonProperty("faceCaptureProvider")
  private FaceCaptureProviders faceCaptureProvider = null;

  @JsonProperty("verifyFaceIdentityExternally")
  private Boolean verifyFaceIdentityExternally = null;
  ...
  public StartBioEnrollmentSessionRequest subjectIdentifier(String subjectIdentifier) {
  ...
  **/
  ...
  public StartBioEnrollmentSessionRequest captureIdentificationDocument(Boolean captureIdentificationDocument) {
    this.captureIdentificationDocument = captureIdentificationDocument;
    return this;
  }

   /**
   * Get captureIdentificationDocument
   * @return captureIdentificationDocument
  **/
  @Schema(description = "")
  public Boolean isCaptureIdentificationDocument() {
    return captureIdentificationDocument;
  }
  ...
  public StartBioEnrollmentSessionRequest dangerousOverrideIfAlreadyEnrolled(Boolean dangerousOverrideIfAlreadyEnrolled) {
    this.dangerousOverrideIfAlreadyEnrolled = dangerousOverrideIfAlreadyEnrolled;
    return this;
  }

   /**
   * Get dangerousOverrideIfAlreadyEnrolled
   * @return dangerousOverrideIfAlreadyEnrolled
  **/
  @Schema(description = "")
  public Boolean isDangerousOverrideIfAlreadyEnrolled() {
    return dangerousOverrideIfAlreadyEnrolled;
  }
  ...
  public StartBioEnrollmentSessionRequest faceCaptureProvider(FaceCaptureProviders faceCaptureProvider) {
  ...
  **/
  ...
  public StartBioEnrollmentSessionRequest verifyFaceIdentityExternally(Boolean verifyFaceIdentityExternally) {
    this.verifyFaceIdentityExternally = verifyFaceIdentityExternally;
    return this;
  }

   /**
   * Get verifyFaceIdentityExternally
   * @return verifyFaceIdentityExternally
  **/
  @Schema(description = "")
  public Boolean isVerifyFaceIdentityExternally() {
    return verifyFaceIdentityExternally;
  }

  public void setVerifyFaceIdentityExternally(Boolean verifyFaceIdentityExternally) {
    this.verifyFaceIdentityExternally = verifyFaceIdentityExternally;
  }

  public StartBioEnrollmentSessionRequest trustedOrigin(String trustedOrigin) {
  ...
  **/
  ...
  public StartBioEnrollmentSessionRequest returnUrl(String returnUrl) {
  ...
  **/
  ...
  public StartBioEnrollmentSessionRequest platformPreference(BioSessionPlatformPreferences platformPreference) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    StartBioEnrollmentSessionRequest startBioEnrollmentSessionRequest = (StartBioEnrollmentSessionRequest) o;
    return Objects.equals(this.subjectIdentifier, startBioEnrollmentSessionRequest.subjectIdentifier) &&
        Objects.equals(this.captureIdentificationDocument, startBioEnrollmentSessionRequest.captureIdentificationDocument) &&
        Objects.equals(this.dangerousOverrideIfAlreadyEnrolled, startBioEnrollmentSessionRequest.dangerousOverrideIfAlreadyEnrolled) &&
        Objects.equals(this.faceCaptureProvider, startBioEnrollmentSessionRequest.faceCaptureProvider) &&
        Objects.equals(this.verifyFaceIdentityExternally, startBioEnrollmentSessionRequest.verifyFaceIdentityExternally) &&
        Objects.equals(this.trustedOrigin, startBioEnrollmentSessionRequest.trustedOrigin) &&
        Objects.equals(this.returnUrl, startBioEnrollmentSessionRequest.returnUrl) &&
        Objects.equals(this.platformPreference, startBioEnrollmentSessionRequest.platformPreference);
  }

  @Override
  public int hashCode() {
    return Objects.hash(subjectIdentifier, captureIdentificationDocument, dangerousOverrideIfAlreadyEnrolled, faceCaptureProvider, verifyFaceIdentityExternally, trustedOrigin, returnUrl, platformPreference);
  }
  ...
  public String toString() {
    ...
    sb.append("class StartBioEnrollmentSessionRequest {\n");
    
    sb.append("    subjectIdentifier: ").append(toIndentedString(subjectIdentifier)).append("\n");
    sb.append("    captureIdentificationDocument: ").append(toIndentedString(captureIdentificationDocument)).append("\n");
    sb.append("    dangerousOverrideIfAlreadyEnrolled: ").append(toIndentedString(dangerousOverrideIfAlreadyEnrolled)).append("\n");
    sb.append("    faceCaptureProvider: ").append(toIndentedString(faceCaptureProvider)).append("\n");
    sb.append("    verifyFaceIdentityExternally: ").append(toIndentedString(verifyFaceIdentityExternally)).append("\n");
