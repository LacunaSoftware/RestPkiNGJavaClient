...
/**
 * Gets or Sets PadesTextHorizontalAlign
 */
public enum PadesTextHorizontalAlign {
  ...
  PadesTextHorizontalAlign(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PadesTextHorizontalAlign fromValue(String input) {
    for (PadesTextHorizontalAlign b : PadesTextHorizontalAlign.values()) {
