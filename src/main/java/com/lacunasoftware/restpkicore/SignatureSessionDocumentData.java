...
public class SignatureSessionDocumentData {
  ...
  public SignatureSessionDocumentData id(UUID id) {
   ...
   /**
   * ID of an existing document to be signed by another user. Specify either this property or &#x60;File&#x60;, but not both.
   * @return id
  **/
  @Schema(description = "ID of an existing document to be signed by another user. Specify either this property or `File`, but not both.")
  public UUID getId() {
    return id;
  }
  ...
  **/
  ...
  public SignatureSessionDocumentData putMetadataItem(String key, List<String> metadataItem) {
   ...
   /**
   * Metadata to be added to the document
   * @return metadata
  **/
  @Schema(description = "Metadata to be added to the document")
  ...
  public SignatureSessionDocumentData documentKey(String documentKey) {
   ...
   /**
   * Document key previously allocated. If omitted, a new document key will be generated.
   * @return documentKey
  **/
  @Schema(description = "Document key previously allocated. If omitted, a new document key will be generated.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, file, metadata, documentKey, signatureType, pdfSignatureOptions, cmsSignatureOptions);
  }
