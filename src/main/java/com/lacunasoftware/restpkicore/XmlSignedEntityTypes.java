...
/**
 * Gets or Sets XmlSignedEntityTypes
 */
public enum XmlSignedEntityTypes {
  ...
  XmlSignedEntityTypes(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static XmlSignedEntityTypes fromValue(String input) {
    for (XmlSignedEntityTypes b : XmlSignedEntityTypes.values()) {
