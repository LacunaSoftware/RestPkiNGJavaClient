...
public class PdfSignatureOptions {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(visualRepresentation, measurementUnits, pageOptimization, reason, customSignatureFieldName, bypassMarksIfSigned, marks, certificationLevel);
  }
