 ...
 */
@JsonPropertyOrder({
  PdfSignatureOptions.JSON_PROPERTY_VISUAL_REPRESENTATION,
  PdfSignatureOptions.JSON_PROPERTY_MEASUREMENT_UNITS,
  PdfSignatureOptions.JSON_PROPERTY_PAGE_OPTIMIZATION
})
public class PdfSignatureOptions {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(visualRepresentation, measurementUnits, pageOptimization);
  }
  ...
  public static class Builder {
    ...
    private PdfSignatureOptions instance;

    public Builder() {
      this(new PdfSignatureOptions());
    }

    protected Builder(PdfSignatureOptions instance) {
      this.instance = instance;
    }

    public PdfSignatureOptions.Builder visualRepresentation(PadesVisualRepresentationModel visualRepresentation) {
      this.instance.visualRepresentation = visualRepresentation;
      return this;
    }
    public PdfSignatureOptions.Builder measurementUnits(PadesMeasurementUnits measurementUnits) {
      this.instance.measurementUnits = measurementUnits;
      return this;
    }
    public PdfSignatureOptions.Builder pageOptimization(PadesPageOptimizationModel pageOptimization) {
    ...
    /**
    * returns a built PdfSignatureOptions instance.
    *
    * The builder is not reusable.
    */
    public PdfSignatureOptions build() {
      try {
  ...
  */
  public static PdfSignatureOptions.Builder builder() {
    return new PdfSignatureOptions.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public PdfSignatureOptions.Builder toBuilder() {
    return new PdfSignatureOptions.Builder()
