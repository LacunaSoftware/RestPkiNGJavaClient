...
public class PdfSignatureOptions {
  ...
  @JsonProperty("marks")
  private List<PdfMarkModel> marks = null;
  ...
  public PdfSignatureOptions visualRepresentation(PadesVisualRepresentationModel visualRepresentation) {
  ...
  **/
  ...
  public PdfSignatureOptions measurementUnits(PadesMeasurementUnits measurementUnits) {
  ...
  **/
  ...
  public PdfSignatureOptions pageOptimization(PadesPageOptimizationModel pageOptimization) {
  ...
  **/
  ...
  public PdfSignatureOptions reason(String reason) {
    this.reason = reason;
    return this;
  }
  ...
  **/
  ...
  public PdfSignatureOptions customSignatureFieldName(String customSignatureFieldName) {
  ...
  **/
  ...
  public PdfSignatureOptions bypassMarksIfSigned(Boolean bypassMarksIfSigned) {
  ...
  **/
  ...
  public PdfSignatureOptions marks(List<PdfMarkModel> marks) {
    this.marks = marks;
    return this;
  }

  public PdfSignatureOptions addMarksItem(PdfMarkModel marksItem) {
    if (this.marks == null) {
  ...
  **/
  ...
  public PdfSignatureOptions certificationLevel(PadesCertificationLevel certificationLevel) {
  ...
  **/
  ...
  public PdfSignatureOptions convertToPdfA(Boolean convertToPdfA) {
    this.convertToPdfA = convertToPdfA;
    return this;
  }

   /**
   * Indicates whether the document should be converted to PDF/A during processing.    Note: This conversion feature must be enabled and properly configured in the system.  If the conversion to PDF/A is not enabled in the current server, an ApiException  will be thrown when attempting to perform the conversion.
   * @return convertToPdfA
  **/
  @Schema(description = "Indicates whether the document should be converted to PDF/A during processing.    Note: This conversion feature must be enabled and properly configured in the system.  If the conversion to PDF/A is not enabled in the current server, an ApiException  will be thrown when attempting to perform the conversion.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PdfSignatureOptions pdfSignatureOptions = (PdfSignatureOptions) o;
    return Objects.equals(this.visualRepresentation, pdfSignatureOptions.visualRepresentation) &&
        Objects.equals(this.measurementUnits, pdfSignatureOptions.measurementUnits) &&
        Objects.equals(this.pageOptimization, pdfSignatureOptions.pageOptimization) &&
        Objects.equals(this.reason, pdfSignatureOptions.reason) &&
        Objects.equals(this.customSignatureFieldName, pdfSignatureOptions.customSignatureFieldName) &&
        Objects.equals(this.bypassMarksIfSigned, pdfSignatureOptions.bypassMarksIfSigned) &&
        Objects.equals(this.marks, pdfSignatureOptions.marks) &&
        Objects.equals(this.certificationLevel, pdfSignatureOptions.certificationLevel) &&
        Objects.equals(this.convertToPdfA, pdfSignatureOptions.convertToPdfA);
  }

  @Override
  public int hashCode() {
    return Objects.hash(visualRepresentation, measurementUnits, pageOptimization, reason, customSignatureFieldName, bypassMarksIfSigned, marks, certificationLevel, convertToPdfA);
  }
  ...
  public String toString() {
    ...
    sb.append("class PdfSignatureOptions {\n");
