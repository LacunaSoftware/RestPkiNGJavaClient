...
public class PadesVisualTextModel {
  ...
  private PadesTextHorizontalAlign horizontalAlign = null;
  ...
  **/
  ...
  public PadesVisualTextModel text(String text) {
   ...
   /**
   * Text to be written on the signature visual representation. The text may contain tags in the format {{tagName}} which will be  substituted with according values. The supported tags are {{signerName}}, {{signerNationalId}}, {{signerEmail}} and {{issuerCommonName}}.
   * @return text
  **/
  @Schema(description = "Text to be written on the signature visual representation. The text may contain tags in the format {{tagName}} which will be  substituted with according values. The supported tags are {{signerName}}, {{signerNationalId}}, {{signerEmail}} and {{issuerCommonName}}.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.fontSize, padesVisualTextModel.fontSize) &&
        Objects.equals(this.text, padesVisualTextModel.text) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fontSize, text, includeSigningTime, horizontalAlign, container);
  }
