...
public enum CmsContentTypes {
  ...
  @JsonCreator
  public static CmsContentTypes fromValue(String input) {
    for (CmsContentTypes b : CmsContentTypes.values()) {
