...
public class CreateSignatureSessionResponse {
  ...
  public CreateSignatureSessionResponse sessionId(UUID sessionId) {
   ...
   /**
   * ID of the signature session created
   * @return sessionId
  **/
  @Schema(description = "ID of the signature session created")
  ...
  public CreateSignatureSessionResponse redirectUrl(String redirectUrl) {
   ...
   /**
   * URL to which the user must be redirected
   * @return redirectUrl
  **/
  @Schema(description = "URL to which the user must be redirected")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateSignatureSessionResponse createSignatureSessionResponse = (CreateSignatureSessionResponse) o;
    return Objects.equals(this.sessionId, createSignatureSessionResponse.sessionId) &&
        Objects.equals(this.redirectUrl, createSignatureSessionResponse.redirectUrl);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateSignatureSessionResponse {\n");
