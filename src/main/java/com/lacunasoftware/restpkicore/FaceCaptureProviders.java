...
/**
 * Gets or Sets FaceCaptureProviders
 */
public enum FaceCaptureProviders {
  FACETECLIVENESS3D("FaceTecLiveness3d"),
  FORTFACESDKLIVENESS("FortFaceSdkLiveness");

  private String value;

  FaceCaptureProviders(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static FaceCaptureProviders fromValue(String input) {
    for (FaceCaptureProviders b : FaceCaptureProviders.values()) {
