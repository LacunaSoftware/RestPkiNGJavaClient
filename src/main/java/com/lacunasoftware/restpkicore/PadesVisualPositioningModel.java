...
public class PadesVisualPositioningModel {
  ...
  public PadesVisualPositioningModel pageNumber(Integer pageNumber) {
   ...
   /**
   * Page on which to insert the visual representation. Negative values denote pages counted  from the end of the document (-1 means last page). Zero denotes that, if no signatures are  present, a new page should be appended to the document.
   * @return pageNumber
  **/
  @Schema(description = "Page on which to insert the visual representation. Negative values denote pages counted  from the end of the document (-1 means last page). Zero denotes that, if no signatures are  present, a new page should be appended to the document.")
