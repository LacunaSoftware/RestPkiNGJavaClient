...
public class CertificateRequirement {
  ...
  **/
  ...
  public CertificateRequirement argument(String argument) {
   ...
   /**
   * The argument for the requirement. Please refer to the &#x60;CertificateRequirementTypes&#x60; enum for the argument syntax for each requirement type.
   * @return argument
  **/
  @Schema(description = "The argument for the requirement. Please refer to the `CertificateRequirementTypes` enum for the argument syntax for each requirement type.")
