...
public class CadesSignaturePostRequestV3 {
  ...
  public CadesSignaturePostRequestV3 dataHashes(List<DigestAlgorithmAndValueModel> dataHashes) {
    this.dataHashes = dataHashes;
    return this;
  }

  public CadesSignaturePostRequestV3 addDataHashesItem(DigestAlgorithmAndValueModel dataHashesItem) {
  ...
  **/
  ...
  public CadesSignaturePostRequestV3 fileToSign(FileModel fileToSign) {
  ...
  **/
  ...
  public CadesSignaturePostRequestV3 cmsToCoSign(FileModel cmsToCoSign) {
  ...
  **/
  ...
  public CadesSignaturePostRequestV3 encapsulateContent(Boolean encapsulateContent) {
    this.encapsulateContent = encapsulateContent;
    return this;
  }

   /**
   * Optionally denotes whether the resulting CMS should include the content signed. If ommitted, the following rules apply:  - If no CmsToSign is given, the resulting CMS will include the content  - If a CmsToCoSign is given, the resulting CMS will include the content if and only if the CmsToCoSign also includes the content
   * @return encapsulateContent
  **/
  @Schema(description = "Optionally denotes whether the resulting CMS should include the content signed. If ommitted, the following rules apply:  - If no CmsToSign is given, the resulting CMS will include the content  - If a CmsToCoSign is given, the resulting CMS will include the content if and only if the CmsToCoSign also includes the content")
  ...
  public CadesSignaturePostRequestV3 certificate(byte[] certificate) {
  ...
  **/
  ...
  public CadesSignaturePostRequestV3 signaturePolicyId(UUID signaturePolicyId) {
  ...
  **/
  ...
  public CadesSignaturePostRequestV3 securityContextId(UUID securityContextId) {
  ...
  **/
  ...
  public CadesSignaturePostRequestV3 callbackArgument(String callbackArgument) {
  ...
  **/
  ...
  public CadesSignaturePostRequestV3 ignoreRevocationStatusUnknown(Boolean ignoreRevocationStatusUnknown) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CadesSignaturePostRequestV3 cadesSignaturePostRequestV3 = (CadesSignaturePostRequestV3) o;
    return Objects.equals(this.dataHashes, cadesSignaturePostRequestV3.dataHashes) &&
        Objects.equals(this.fileToSign, cadesSignaturePostRequestV3.fileToSign) &&
        Objects.equals(this.cmsToCoSign, cadesSignaturePostRequestV3.cmsToCoSign) &&
        Objects.equals(this.encapsulateContent, cadesSignaturePostRequestV3.encapsulateContent) &&
        Arrays.equals(this.certificate, cadesSignaturePostRequestV3.certificate) &&
        Objects.equals(this.signaturePolicyId, cadesSignaturePostRequestV3.signaturePolicyId) &&
        Objects.equals(this.securityContextId, cadesSignaturePostRequestV3.securityContextId) &&
        Objects.equals(this.callbackArgument, cadesSignaturePostRequestV3.callbackArgument) &&
        Objects.equals(this.ignoreRevocationStatusUnknown, cadesSignaturePostRequestV3.ignoreRevocationStatusUnknown);
  }

  @Override
  public int hashCode() {
    return Objects.hash(dataHashes, fileToSign, cmsToCoSign, encapsulateContent, Arrays.hashCode(certificate), signaturePolicyId, securityContextId, callbackArgument, ignoreRevocationStatusUnknown);
  }
  ...
  public String toString() {
    ...
    sb.append("    cmsToCoSign: ").append(toIndentedString(cmsToCoSign)).append("\n");
    sb.append("    encapsulateContent: ").append(toIndentedString(encapsulateContent)).append("\n");
