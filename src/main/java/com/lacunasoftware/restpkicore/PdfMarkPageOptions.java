...
/**
 * Gets or Sets PdfMarkPageOptions
 */
public enum PdfMarkPageOptions {
  ...
  PdfMarkPageOptions(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static PdfMarkPageOptions fromValue(String input) {
    for (PdfMarkPageOptions b : PdfMarkPageOptions.values()) {
