...
import com.lacunasoftware.restpkicore.SubscriptionAccessModelRolesRootRolesApplicationModel;
...
class SubscriptionAccessModelRolesRootRolesApplicationModelPaginatedSearchResponse {
  @JsonProperty("items")
