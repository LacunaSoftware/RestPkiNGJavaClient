...
public class StampPdfRequest {
  ...
  @JsonProperty("timestampTier")
  private String timestampTier = null;
  ...
  public StampPdfRequest file(FileReferenceModel file) {
    this.file = file;
    return this;
  }
  ...
  **/
  ...
  public StampPdfRequest timestampTier(String timestampTier) {
   ...
   /**
   * The ID or name of a timestamp tier to be used to timestamp the document. If omitted, the default tier will be assumed.
   * @return timestampTier
  **/
  @Schema(description = "The ID or name of a timestamp tier to be used to timestamp the document. If omitted, the default tier will be assumed.")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.file, stampPdfRequest.file) &&
        Objects.equals(this.timestampTier, stampPdfRequest.timestampTier) &&
        Objects.equals(this.customSignatureFieldName, stampPdfRequest.customSignatureFieldName) &&
        Objects.equals(this.reason, stampPdfRequest.reason) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(file, timestampTier, customSignatureFieldName, reason, forceBlobResult, visualRepresentation);
  }
