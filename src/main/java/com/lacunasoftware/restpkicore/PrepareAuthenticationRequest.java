...
public class PrepareAuthenticationRequest {
  ...
  public PrepareAuthenticationRequest securityContextId(UUID securityContextId) {
   ...
   /**
   * The ID of a security context to be used to validate the user&#x27;s certificate. If omitted, the default security context configured on the subscription will be assumed.
   * @return securityContextId
  **/
  @Schema(description = "The ID of a security context to be used to validate the user's certificate. If omitted, the default security context configured on the subscription will be assumed.")
  ...
  public PrepareAuthenticationRequest ignoreRevocationStatusUnknown(Boolean ignoreRevocationStatusUnknown) {
   ...
   /**
   * Whether a certificate whose revocation status cannot be assertained should still be considered valid. If omitted, the default configuration for the  subscription will be used.
   * @return ignoreRevocationStatusUnknown
  **/
  @Schema(description = "Whether a certificate whose revocation status cannot be assertained should still be considered valid. If omitted, the default configuration for the  subscription will be used.")
