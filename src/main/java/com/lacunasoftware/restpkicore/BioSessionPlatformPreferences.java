...
/**
 * Gets or Sets BioSessionPlatformPreferences
 */
public enum BioSessionPlatformPreferences {
  ...
  BioSessionPlatformPreferences(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static BioSessionPlatformPreferences fromValue(String input) {
    for (BioSessionPlatformPreferences b : BioSessionPlatformPreferences.values()) {
