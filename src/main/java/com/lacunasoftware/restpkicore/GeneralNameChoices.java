...
/**
 * Gets or Sets GeneralNameChoices
 */
public enum GeneralNameChoices {
  OTHERNAME("OtherName"),
  ...
  GeneralNameChoices(String value) {
    this.value = value;
  }
  ...
  @JsonCreator
  public static GeneralNameChoices fromValue(String input) {
    for (GeneralNameChoices b : GeneralNameChoices.values()) {
