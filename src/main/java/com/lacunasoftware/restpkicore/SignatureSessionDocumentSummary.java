...
public class SignatureSessionDocumentSummary {
  ...
  **/
  ...
  public SignatureSessionDocumentSummary dateSigned(Date dateSigned) {
   ...
   /**
   * Date on which this document was signed on the specific signature session that was fetched
   * @return dateSigned
  **/
  @Schema(description = "Date on which this document was signed on the specific signature session that was fetched")
  ...
  **/
  ...
  public SignatureSessionDocumentSummary dateCreated(Date dateCreated) {
  ...
  **/
  ...
  public SignatureSessionDocumentSummary subscriptionId(UUID subscriptionId) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, signatureSessionDocumentSummary.status) &&
        ...
        Objects.equals(this.dateCreated, signatureSessionDocumentSummary.dateCreated) &&
        Objects.equals(this.subscriptionId, signatureSessionDocumentSummary.subscriptionId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(status, dateSigned, id, key, dateCreated, subscriptionId, formattedKey, originalFile, markedFile, signedFile, signatureType, availableUntil);
  }
