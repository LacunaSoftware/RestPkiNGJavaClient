...
class CreateSignatureSessionRequest {
  ...
  **/
  ...
  public CreateSignatureSessionRequest putDocumentMetadataItem(String key, List<String> documentMetadataItem) {
    if (this.documentMetadata == null) {
      this.documentMetadata = new HashMap<String, List<String>>();
    }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(returnUrl, securityContextId, callbackArgument, enableBackgroundProcessing, disableDownloads, documentMetadata);
  }
