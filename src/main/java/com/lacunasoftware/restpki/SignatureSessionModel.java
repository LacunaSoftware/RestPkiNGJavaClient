...
public class SignatureSessionModel {
  ...
  **/
  ...
  public SignatureSessionModel documents(List<DocumentModel> documents) {
    this.documents = documents;
    return this;
  }

  public SignatureSessionModel addDocumentsItem(DocumentModel documentsItem) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(id, status, callbackArgument, documents);
  }
