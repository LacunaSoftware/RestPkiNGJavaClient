...
@javax.annotation.Generated(value = "io.swagger.codegen.v3.generators.java.JavaClientCodegen", date = "2021-06-11T15:24:24.708-03:00[America/Sao_Paulo]")public class DocumentModel {
  ...
  public DocumentModel addSignersItem(SignerSummary signersItem) {
    if (this.signers == null) {
      this.signers = new ArrayList<SignerSummary>();
    }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return java.util.Objects.hash(signers, metadata, id, key, formattedKey, originalFile, signedFile, signatureType, availableUntil);
  }
